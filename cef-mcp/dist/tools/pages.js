...
export function registerPageTools(server) {
    server.tool('cdp_list_pages', 'List all available pages/targets from the CDP endpoint', {}, async () => {
        try {
    ...
    server.tool('cdp_select_page', 'Select a page to interact with by index number or pattern match on title/URL', {
