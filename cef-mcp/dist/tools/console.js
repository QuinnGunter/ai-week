...
export function registerConsoleTools(server) {
    server.tool('cdp_get_logs', 'Get console messages collected from the CDP session. Optionally filter by level.', {
    ...
    server.tool('cdp_clear_logs', 'Clear all collected console logs', {}, async () => {
