...
struct COMPONENT_EXPORT(MEDIA_CAPTURE_MOJOM_TRAITS)
  ...
  static bool enable_segmentation(const media::VideoCaptureParams& params) {
    return params.enable_segmentation;
  }
  ...
  // MMHMM: Add stream_configuration_json serialization
  static const std::string& stream_configuration_json(
      const media::VideoCaptureParams& params) {
    return params.stream_configuration_json;
  }
