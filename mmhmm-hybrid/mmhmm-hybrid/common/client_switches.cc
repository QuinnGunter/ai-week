...
const char kDisableNativeSegmentation[] = "disable-native-segmentation";
const char kAllowMiniRemoteCapture[] = "allow-mini-remote-capture";

const char kLogFile[] = "log-file";
const char kLogSeverity[] = "log-severity";

const char kDisableSentry[] = "disable-sentry";
const char kSendTestSentryError[] = "send-test-sentry-error";
const char kServiceConfiguration[] = "service-configuration";

const char kAppMode[] = "app-mode";
const char kWebApp[] = "web-app";
