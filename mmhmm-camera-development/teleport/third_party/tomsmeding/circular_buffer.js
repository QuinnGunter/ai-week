// Code extracted from: https://www.npmjs.com/package/circular-buffer
// Licensed ISC (npm) / MIT (repo).
// Statement from the author:
// (...)
// circular-buffer is licensed under MIT, which I assume is not an issue for you. (If it is, we can discuss.)
// I will add an explicit licence file to the repository when I get the time. (...)
// Cheers,
// Tom
...
CircularBuffer.prototype={
	...
	// Filip Mroz: added average function
	avg:function(){
		let avgArray = this.toarray();
		return avgArray.reduce((a, b) => a + b, 0) / avgArray.length;
	}
};
